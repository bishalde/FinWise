...
extension ThemeExtension on ThemeData {
  ...
  TextStyle get kTitleTextStyle => GoogleFonts.sourceCodePro(
      fontWeight: FontWeight.w700, color: btnTextCol, fontSize: 25);
  TextStyle get kSubTitleTextStyle => GoogleFonts.sourceCodePro(
      fontSize: 17, color: btnTextCol, fontWeight: FontWeight.w700);
  TextStyle get kMedTitleTextStyle => GoogleFonts.sourceCodePro(
      fontSize: 22, color: btnTextCol, fontWeight: FontWeight.w700);
  TextStyle get kSmallTextStyle =>
      GoogleFonts.sourceCodePro(fontWeight: FontWeight.w700, color: btnTextCol);
  TextStyle get kVerySmallTextStyle => GoogleFonts.sourceCodePro(
      fontWeight: FontWeight.w700, color: btnTextCol, fontSize: 12);
  TextStyle get kBigTextStyle => GoogleFonts.sourceCodePro(
